...
$("#login").click(function() {
    ...
    $.ajax({
        ...
        url: "http://localhost:3000/account/locator/login",
        type: "POST",
        dataType: "json",
        ...
        if (data.auth) {
            ...
            alert("Sai tafi khoanr hoawjc maajt kharau");
        }
    });
});
...
$("#register").click(function() {
    if ($("#password").val() === $("#re-password").val()) {
        ...
        $.ajax({
            contentType: "application/json",
            url: "http://localhost:3000/account/locator/register",
            type: "POST",
            dataType: "json",
            data: JSON.stringify(formdata),
            timeout: 10000,
            ...
            .done(function(data) {
                if (data.duplicate) {
                    ...
                    swal(
                        "Thành công!",
                        `${formdata.username} đã trở thành định vị viên.`,
                        "success"
                    );
                }
            })
